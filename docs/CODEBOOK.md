...
| text | Control statement (curated subset — every row checked against the source catalog 2026-09-20) | see LIMITATIONS.md §1 |
| verify_flag | `VERIFIED` as of 2026-09-20 | records that every SP 800-53 row was checked verbatim against the source |
...
| tentative_alignment_type | Machine-generated rule-based bucket from cosine_similarity: Direct (≥0.30) / Partial (≥0.18) / Related (≥0.08) / No Match — superseded by the human adjudication for every row that reached the review queue | 03_align.py; thresholds documented and challengeable, see BUILD_SPEC.md |
...
| cosine_similarity / tentative_alignment_type | The machine's score and its tentative bucket | copied from candidate_crosswalk.csv |
...
| ai_suggested_type / ai_suggested_rationale | An AI-drafted suggestion (for the 149 rows the author worked through with Claude) — not the final call; see adjudicated_alignment_type below | added during interactive adjudication, 2026-09-20 |
| adjudicated_alignment_type | The human adjudicator's final call: Direct / Partial / Related / No Match / Reject — filled for all 149 rows | filled in by the author, 2026-09-20 |
| adjudicator | Name of the person who made the call | Friday Ogochukwu Ikwuogu, all 149 rows |
| adjudication_rationale | One to two sentences on why | filled in by the author, all 149 rows |
| adjudication_date | ISO date of the decision | 2026-09-20, all 149 rows |
